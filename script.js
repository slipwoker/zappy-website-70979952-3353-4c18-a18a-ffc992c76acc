document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        function validateField(field) {
            ...
            if (isValid && field.hasAttribute('pattern') && value !== '') {
                ...
                if (!pattern.test(value)) {
                    isValid = false;
                    errorMessage = field.getAttribute('data-error-pattern') || 'Please match the requested format';
                }
            }
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            const actionUrl = contactForm.getAttribute('action') || window.location.href;
            ...
            if (method === 'POST' || method === 'PUT' || method === 'PATCH') {
                const contentType = contactForm.getAttribute('enctype');
            ...
            fetch(actionUrl, fetchOptions)
                ...
                .then(function() {
                    ...
                    successMessage.textContent = contactForm.getAttribute('data-success-message') || 'Thank you! Your message has been sent successfully.';
                ...
                .catch(function() {
                    ...
                    errorMessage.textContent = contactForm.getAttribute('data-error-message') || 'Oops! Something went wrong. Please try again.';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '70979952-3353-4c18-a18a-ffc992c76acc',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '70979952-3353-4c18-a18a-ffc992c76acc';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '70979952-3353-4c18-a18a-ffc992c76acc';
